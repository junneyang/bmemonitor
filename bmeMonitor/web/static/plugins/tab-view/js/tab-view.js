...
************************************************************************************************************/
	...
	function showTab(parentId,tabIndex)
	{
		...
		if(activeTabIndex[parentId]>=0){
			...
			img.src = '/static/plugins/tab-view/images/tab_right_inactive.gif';
		...
		img.src = '/static/plugins/tab-view/images/tab_right_active.gif';
	...
	function rolloverTab()
	{
		if(this.className.indexOf('tabInactive')>=0){
			...
			img.src = '/static/plugins/tab-view/images/tab_right_over.gif';
		}
	...
	{
		this.src = this.src.replace('/static/plugins/tab-view/images/close.gif','/static/plugins/tab-view/images/close_over.gif');
	}

	function stopHoverTabViewCloseButton()
	{
		this.src = this.src.replace('/static/plugins/tab-view/images/close_over.gif','/static/plugins/tab-view/images/close.gif');
	}
	...
	function initTabs(mainContainerID,tabTitles,activeTab,width,height,closeButtonArray,additionalTab)
	{
		...
		for(var no=0;no<tabTitles.length;no++){
			...
			if(closeButtonArray[no]){
				...
				closeButton.src = '/static/plugins/tab-view/images/close.gif';
